...
--
-- Host: localhost
-- Erstellungszeit: 24. August 2008 um 20:35
...
--
-- Tabellenstruktur für Tabelle `gbook_addons_old`
--

CREATE TABLE IF NOT EXISTS `gbook_addons_old` (
...
--
-- Daten für Tabelle `gbook_addons_old`
--
...
('default_lang', '1'),
('active', '1'),
('description', 'Das OpenSource GÃƒÂ¤stebuch'),
('sitename', 'qGuestbook'),
('debug_info', '1'),
('show_warnings', '1'),
('disable_msg', 'Das Gaestebuch wurde vom Administrator gesperrt!\r\n\r\nBitte versuche es spaeter noch einmal.'),
('submit_msg', 'Vielen Dank fuer deinen Eintrag in unserem Gaestebuch!'),
('enable_icq', '1'),
('enable_www', '1'),
('version', '0.2.5'),
('smilies_path', 'modules/smilies/images/'),
('posts_site', '5'),
('admin_link', '1'),
('gzip', '0'),
('moderated', '0'),
...
('allow_mark_post', '1'),
('charset', 'UTF-8'),
('startdate', '1219602348'),
('max_lenght', '66'),
('success_email_text', 'Hallo %1s!\r\n\r\nVielen Dank fuer deinen Eintrag in unser Gaestebuch.\r\nDein Eintrag muss moeglicherweisse erst freigeschaltet werden und ist daher noch nicht sichtbar.\r\n\r\nWichtig: Deine IP Adresse wurde aus Sicherheitsgruenden gespeichert. Sie ist vom Administrator jederzeit einsehbar.'),
...
('success_email_admin_text', 'Hallo,\r\n\r\nDu bist Moderator im Gaestebuch, deshalb erhaelst du diese E-Mail.\r\n\r\nDer Benutzer %1s hat soeben einen neuen Eintrag geschrieben.\r\n\r\nEr hat folgendes geschrieben:\r\n\r\n---\r\n%2s\r\n---\r\n\r\nDas Gaestebuch kannst du unter der folgenden Adresse erreichen: %3s'),
...
INSERT INTO `gbook_posts` (`posts_id`, `posts_name`, `posts_email`, `posts_ip`, `posts_www`, `posts_icq`, `posts_text`, `posts_date`, `posts_active`, `posts_hide_email`, `posts_marked`) VALUES
(1, 'qGuestbook', 'support.qgb@simlau.net', '7f000001', 'http://www.simlau.net/', '206092388', 'Vielen Dank das du dich fÃƒÂ¼r [b]qGuestbook[/b] entschieden hast!\r\n\r\nDies ist ein Testbeitrag, du kannst ihn spÃƒÂ¤ter lÃƒÂ¶schen.\r\n\r\nWas zeichnet qGuestbook aus?\r\n[list]\r\n[*] Objektorientiert in PHP5 programmiert\r\n[*] UnterstÃƒÂ¼tzt MySQL, PostgreSQL und SQLite (Implementierung weiterer mÃƒÂ¶glich)\r\n[*] Diverse SchutzmÃƒÂ¶glichkeiten gegen Spambots (Captcha, Refferer-Check etc.)\r\n[*] Benutzersystem (GÃƒÂ¤ste, Moderatoren, Administratoren usw.)\r\n[*] Badwords, Smilies, BBCodes\r\n[*] Zensur langer WÃƒÂ¶rter\r\n[*] Erweitertes Templatesystem\r\n[*] Einfaches einstellen von HTML Meta-Tags\r\n[*] Und natÃƒÂ¼rlich noch vieles mehr!\r\n[/list]\r\n\r\nIn diesem Sinne viel SpaÃƒÅ¸ mit qGuestbook!\r\n\r\nFalls Probleme und Fragen auftreten sollen kannst du dich an uns im [url=http://forum.simlau.net/]Forum[/url] von [url=http://www.simlau.net]Simlau.net[/url] wenden.', '1207769061', '1', '1', '0');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gbook_session`
--

CREATE TABLE IF NOT EXISTS `gbook_session` (
  `session_id` int(11) NOT NULL auto_increment,
  `session_session` varchar(55) NOT NULL,
  `session_time` varchar(55) NOT NULL,
  `session_ip` varchar(55) NOT NULL,
  `session_data` varchar(55) NOT NULL,
  PRIMARY KEY  (`session_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Daten für Tabelle `gbook_session`
--
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@example.com', '', '', '', '3');
